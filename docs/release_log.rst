...
* 2.0.0 - unreleased
    ...
    **Behavior Changes**
    ...
    - Fix ``chargé d'affaires``: shipped as one unmatchable ``TITLES`` entry since it was added, it is now two chainable entries (``chargé``, ``d'affaires``), so the title is recognized
